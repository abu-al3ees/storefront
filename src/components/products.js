...
import { inactive, active } from '../store/categories-reducer';
...
const ProductViewer = (props) => {
  return (
    ...
    <IconButton onClick={() => props.active('Electronics')}>Electronics</IconButton>
    <IconButton onClick={() => props.active('Food')}>Food</IconButton>
    <Paper>
